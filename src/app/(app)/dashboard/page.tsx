      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-foreground-muted text-sm mt-1">Overview of your trading agents</p>
          </div>
          <Button asChild>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="bg-card border border-border">
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-foreground-muted uppercase tracking-wide">Total Balance</p>
                  <p className="text-2xl font-semibold mt-1">$12,450.00</p>
                </div>
                <div className="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center">
                  <WalletIcon className="h-5 w-5 text-primary" />
                </div>
              </div>
              <p className="text-xs text-success mt-3">+12.5% from last week</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border border-border">
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-foreground-muted uppercase tracking-wide">Active Agents</p>
                  <p className="text-2xl font-semibold mt-1">3</p>
                </div>
                <div className="h-10 w-10 rounded-lg bg-success/10 flex items-center justify-center">
                  <BotIcon className="h-5 w-5 text-success" />
                </div>
              </div>
              <p className="text-xs text-foreground-muted mt-3">2 paused, 0 stopped</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border border-border">
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-foreground-muted uppercase tracking-wide">Today&apos;s PnL</p>
                  <p className="text-2xl font-semibold mt-1 text-success">+$342.50</p>
                </div>
                <div className="h-10 w-10 rounded-lg bg-success/10 flex items-center justify-center">
                  <TrendUpIcon className="h-5 w-5 text-success" />
                </div>
              </div>
              <p className="text-xs text-foreground-muted mt-3">5 trades executed</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border border-border">
            <CardContent className="p-5">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-foreground-muted uppercase tracking-wide">Win Rate</p>
              ...
              <p className="text-xs text-foreground-muted mt-3">Last 30 days</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          <Card className="bg-card border border-border">
            <CardHeader className="pb-3">
              <CardTitle className="text-[15px] font-semibold">Active Agents</CardTitle>
            </CardHeader>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-foreground-muted">{agent.strategy}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      ...
                      <p className={`text-xs mt-1 ${agent.pnl >= 0 ? 'text-success' : 'text-error'}`}>
                ...
                {activities.map((activity, index) => (
                  ...
                  >
                    <div className={`h-8 w-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                      ...
                      {activity.type === 'trade' ? (
                        <ArrowsIcon className={`h-4 w-4 ${activity.side === 'long' ? 'text-success' : 'text-error'}`} />
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-subtle mt-1">{activity.time}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <Card className="bg-card border border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-[15px] font-semibold">Open Positions</CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
